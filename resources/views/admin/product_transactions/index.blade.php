    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white flex flex-col gap-y-5 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <a href="{{ route('productTransaction.show', $transaction) }}">
                        ...
                        @endif
                        <div class="hidden md:flex">
                            <a href="{{ route('productTransaction.show', $transaction) }}" class="font-vold py-3 px-5 rounded-full text-white  bg-indigo-500">View Transactions</a>
                        </div>
                    </div>
                    <hr class="my-3">
                @empty
